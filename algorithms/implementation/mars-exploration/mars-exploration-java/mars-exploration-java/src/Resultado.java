public class Resultado {
    ...
    // Método estático que recebe uma string 's' como entrada e retorna o número de caracteres alterados
    public static int marsExploration(String s) {
        ...
        for (int letra = 0; letra < s.length(); letra++) {
            ...
            // Verifica se o índice atual é um índice de 'O' 
            // esperado (a sequência "SOS" tem índices de 'O' em 1, 4, 7, ...)
            if (letra % 3 == 1) {
